...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        TrustProxies::class, HandleCors::class, PreventRequestsDuringMaintenance::class, ValidatePostSize::class,
        TrimStrings::class, ConvertEmptyStringsToNull::class,
    ];
    ...
    protected $routeMiddleware = [
        'auth'             => Authenticate::class, 'auth.basic' => AuthenticateWithBasicAuth::class,
        ...
        /* Own packages */
        'language'         => Language::class, 'admin.authenticate' => AdminAuthenticate::class,
